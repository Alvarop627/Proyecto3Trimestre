...
public class Ventana extends JFrame {
	...
	private static ClasificacionJornada clasificacion;
	private static SeleccionaEquipo selEq;
	private static ProximosPartidos proxPart;
	private static Resultados resultados;
	private static Alineacion alineacion;
	...
	public static void repintarClasificaciones() {
		clasificacion.removeAll();
		clasificacion.initComponents();

	}

	public static void repintarProximosPartidos() {
		proxPart.removeAll();
		proxPart.initComponents();

	}

	public static void repintarResultados() {
	 ...
	 */
	public static ClasificacionJornada getClasificacion() {
	 ...
	 * @return the proxPart
	 */
	public static ProximosPartidos getProxPart() {
		return proxPart;
	}
